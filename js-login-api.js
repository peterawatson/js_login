	var PT_INTEGRATION = (function (window) {
				...
				var loginRequest = function () {  
					...
					{
						//setStatus(2, {"playerMessage" : "Username is mandatory"});
					...
					{
						//setStatus(2, {"playerMessage" : "Password is mandatory"});
				...
				var makeSpace = function(){
					...
					$("forgot").style.opacity = "0.2";
					$("forgot").style.filter  = 'alpha(opacity=20)'; 
				}
				...
				var copyUn = function(){  // copy form data to new login form
				...
				var forgotPasswordRequest = function () {
					...
					var username = $("fpUsername").value,
						...
						//alert(username + " : " + email + " : " + birthDate);
				...
				var bindListeners = function () {
					...
					$("login").addEventListener("click", loginRequest, false);
